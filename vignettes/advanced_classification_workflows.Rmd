...
This vignette demonstrates advanced functions/parameters? for the main classifier(The only one?) in LundTaxR, building upon the concepts introduced in the "Getting Started" guide. If you're new to LundTaxR, we recommend starting with the basic tutorial first:
...
%% we often call the UroA/B/C classes or groups isntead of subtypes. check with Mattias.
%% again no explanaition about sample number lower than total number of samples in dataset?
%% should we mention that the prediction scores are probabilities summing to 1? This is importante to understand the delta score and confidence_summary.
...
%% I would need more detal such as range and how this score affects resulst to be able to use this properly. how reasonable results look like?
...
%% what is the range of the progression risk score? is it 0-1? what is a resonable intrepretation of the score?
